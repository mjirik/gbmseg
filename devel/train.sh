#PBS -l select=1:ncpus=1:ngpus=1:mem=64gb:scratch_local=10gb:cluster=adan -q gpu
...
module add cuda
activate tf_gpu
python /storage/plzen1/home/$LOGNAME/projects/gbm/train.py /storage/plzen1/home/hachaf/projects/gbm/settings.json > /storage/plzen1/home/$LOGNAME/projects/gbm/results.out
